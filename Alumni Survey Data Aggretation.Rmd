...
stargazer(m1, m2, summary = FALSE, header = FALSE, 
          ...
          type="text",
          se = list(rse1, rse2),
          covariate.labels = c("Group: Direct", "Group: Philanthropic", "Gender: Male","Gender: Unknown", "Graduation Year:16","Graduation Year:17","Graduation Year:18","Graduation Year:19","Graduation Year:20","Graduation Year:21" ,"Constant"),
          dep.var.labels = "Survey Completion")


m3 <- d[bounce == 0 , lm(completion ~ Block + Gender + factor(Year_Graduation) + Gender*factor(Year_Graduation))]
rse3 <- sqrt(diag(vcovHC(m3 ,type = "HC1")))
summary(m3)

stargazer(m3, summary = FALSE, header = FALSE, 
          title = "HTE and Estimate with Attriters Removed",
          digits = 3,
          type="text",
          se = list(rse3),
          covariate.labels = c("Group: Direct", "Group: Philanthropic", "Gender: Male","Gender: Unknown", "Graduation Year:16","Graduation Year:17","Graduation Year:18","Graduation Year:19","Graduation Year:20","Graduation Year:21" ,"Male:Graduation Year:16","Unk:Graduation Year:16","Male:Graduation Year:17","Unk:Graduation Year:17","Male:Graduation Year:18","Unk:Graduation Year:18","Male:Graduation Year:19","Unk:Graduation Year:19","Male:Graduation Year:20","Unk:Graduation Year:20","Male:Graduation Year:21","Unk:Graduation Year:21"),
          dep.var.labels = "Survey Completion")
