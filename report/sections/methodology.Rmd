...
The YAMM service provides a near-real time merge status indicator for each email that it sends.  YAMM provides the following email status options: sent, opened, clicked, responded, bounced, and unsubscribed.  While YAMM does not guarantee 100% accuracy with the reported status for any given email, this is the only source of data that allows us to identify non-compliers in our study [@noauthor_how_nodate].
