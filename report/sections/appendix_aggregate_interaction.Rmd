# Appendix C: Data Aggregation and Analysis of HTEs of Gender and Cohort

## Load Data
```{Appendix r load_data}
# list of people
...
## Tabulating HTEs by gender and Cohort

```{Appendix r hte_2, echo=FALSE,comment=''}
d <- data.table(dt_agg)
