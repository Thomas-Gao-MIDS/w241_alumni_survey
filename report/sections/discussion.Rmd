...
$$ 
\begin{aligned}
Y = 0.216 + (0.072 * Male) - (0.025 * Direct) + (0.023 * Philanthropic) - (0.056 * Male * Direct) - (0.074 * Male * Philanthropic) + \epsilon
\end{aligned}
$$
...
```{r anova-gender, echo=FALSE, fig.align="center"}
anova_gender
```

&nbsp;
\begin{center}Table 10: F-test on graduation year interaction terms \end{center}
```{r anova-grad, echo=FALSE, fig.align="center"}
anova_coh
```
